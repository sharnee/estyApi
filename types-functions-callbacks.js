...
var justOneString = function (xInput, yInput){
	if (typeof(xInput && yInput)!=='string'){
		return false;
	}
	else if (typeof(xInput && yInput)!== 'string'){
		return false;
	}
	else return true;
};
...
var doItTwice = function (inputString) {
	return (inputString + " " + inputString)
}
console.assert(doItTwice("may"))
